...
val LANSS = ShortTestPreviewModel(
    ...
    testQuestions = listOf(
        ...
        TestQuestionModel(
            questionId = 3,
            testQuestion = "Повышена ли чувствительность к прикосновению на пораженном участке кожи? Можно ли сказать, что лёгкое поглаживание кожи, соприкосновение с одеждой вызывают неприятные или болевые ощущения?",
            testAnswers = listOf(
                TestAnswerModel(
                    questionId = 3,
                ...
                TestAnswerModel(
                    questionId = 3,
                    testAnswer = "ДА – На пораженном участке чувствительность кожи повышена",
                    answerPoint = 3
                ),
            )
        ),
        ...
        TestQuestionModel(
            questionId = 6,
            testQuestion = "Оцените чувствительность к лёгкому прикосновению ватой на поражённом и здоровом участках кожи. Наличие аллодинии можно констатировать, если прикосновение к пораженному участку кожи вызывает боль или другие неприятные ощущения(покалывание, тошноту), в то время как при проведении теста на здоровом участке кожи подобных ощущений не возникает.",
            testAnswers = listOf(
                TestAnswerModel(
                    questionId = 6,
